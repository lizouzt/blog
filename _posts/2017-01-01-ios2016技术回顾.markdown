...
例如 “I need to send a message to laosiji via WeChat saying had you go to dabaojian again ?"，当用户唤醒Siri说出这句话的时候，Siri会把上面这句话转换成结构化语义意图：
...
* 消息内容（content）：had you go to dabaojian again ?
